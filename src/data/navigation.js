export const defaultNavItems = [
  ...
  { id: 'raw-materials', label: 'Quản lý nguyên liệu', type: 'group' },
  { id: 'raw-material-lot-update', label: 'Nhập lô nguyên liệu', parentId: 'raw-materials', permission: 'raw-materials' },
  { id: 'raw-material-active-lots', label: 'Lô đang sử dụng', parentId: 'raw-materials', permission: 'raw-materials' },
  { id: 'raw-material-balance-adjustment', label: 'Điều chỉnh lô NL', parentId: 'raw-materials', permission: 'raw-materials' },
  { id: 'raw-material-lot-lookup', label: 'Tra cứu lô', parentId: 'raw-materials', permission: 'raw-materials' },
  { id: 'raw-material-consumption-log', label: 'Báo cáo sử dụng NL', parentId: 'raw-materials', permission: 'raw-materials' },
